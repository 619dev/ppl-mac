 ...
 * 2. User login (external_id = PaperPhoneLite user_id) so push targets the right user
...
/**
 * Login the user so OneSignal maps this browser/device to the right PaperPhoneLite user.
