export const en: Record<string, string> = {
  ...
  'profile.clear_cache_confirm': 'Cached contacts and messages will no longer be available offline. Continue?',
  ...
  'profile.delete_warning': 'This action cannot be undone. Deleting your account will permanently remove all your data, including messages and contacts. This data cannot be recovered.',
  ...
  'block.confirm_desc': 'Blocked users cannot send you messages. You can unblock them later.',
